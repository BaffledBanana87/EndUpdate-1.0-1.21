...
import net.baffledbanana87.repurposedend.enchantment.EnchantmentWither;
...
public class RepurposedEnd implements ModInitializer {
	...
	public void onInitialize() {
		...
		FabricDefaultAttributeRegistry.register(ModEntity.CRYING_WITHER, CryingWitherEntity.createCryingWitherAttributes());
